        ...
        <table role="presentation" style="width:602px;border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;text-align:left;">
          <tr>
            <td align="center" style="padding:0px 0 0px 0;background:#70bbd9;">
              <img src="https://i.ibb.co/9VZqy61/kapusta.png" alt="" style="height:auto;display:block;" />
            </td>
          </tr>
          <tr>
              ...
              <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                <tr>
                  <td style="padding:0 0 36px 0;color:#153643;">
                    ...
                    <div style="margin: 30px 0px 0px 0px;background:#FF751D;width: 114px;height: 35px;border-radius: 5px;">
                      <a href="${verificationURL}" style="text-decoration:none;width: 114px;height: 35px">
                        <div style="color: #ffffff; margin: 30px 0px 0px 0px;background:#FF751D;width: 114px;height: 35px; padding-top: 15px;padding-left: 16px;border-radius: 5px;">Confirm email</div>
                      </a>
                    </div>
                  </td>
                </tr>
